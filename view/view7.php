            ...
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <header class="offset-xl-2 offset-lg-2 offset-md-2 offset-sm-2 col-xl-10 col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        <h1>6 - Nos clients enregistrés</h1>
                    </header>
                    <section class="firstTest offset-xl-2 offset-lg-2 offset-md-2 offset-sm-2 col-xl-10 col-lg-10 col-md-10 col-sm-10 col-xs-12 text-center">
                        ...
                        <?php foreach($clients as $listClients){ ?>
                        <div class="listPresentClients">
                            <p>
                                Nom: <?= $listClients->lastName ?><br/>
                                Prénom: <?= $listClients->firstName ?><br />
                                Date de naissance: <?= $listClients->bd ?><br />
                                Carte de fidélité:
                                <?php if($listClients->cardTypesId == 1){?>
                                    Oui
                                <?php } else { ?>
                                    Non
                                <?php } ?>
                                <?php if ($listClients->cardTypesId == 1){ ?>
                                    (N°: <?= $listClients->cardNumber ?>)
                                <?php } ?>
                            </p>
                        </div>
                        <?php } ?>
